...
function checkEmail(input) {
    if (!(0, isEmail_1.default)(input.value))
        showErrorMessage(input, 'O e-mail é inválido!');
}
...
/*!********************************!*\
  !*** ./src/A019-exec/index.ts ***!
  \********************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/A019-exec/form-control.ts");
